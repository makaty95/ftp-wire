...
public class ConnectionManager {
    ...
    private final InetSocketAddress localCommandAddress, localDataAddress;
    ...
    private ConnectionManager() {
        ...
        localDataAddress = new InetSocketAddress(ClientConfig.HOST_NAME, 0);
        localCommandAddress = new InetSocketAddress(ClientConfig.HOST_NAME, 0);
    }
    ...
    public Status initConnection() throws IOException {
        return handshake();
    }

    private Status handshake() throws IOException {
        //TODO: add logs instead of exceptions

        if(remoteCommandAddress == null) {
            return Status.NO_REMOTE_SPECIFIED;
        }

        System.out.println("my address: " + localCommandAddress.getAddress());
        ...
        return donePacket.isPairSuccess() ? Status.SUCCESS : Status.FAILED;
    }
    ...
    public void setRemoteCommandSocketAddress(InetSocketAddress inetSocketAddress) {
        this.remoteCommandAddress = inetSocketAddress;
    }
